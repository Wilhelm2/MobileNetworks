...
#  opp_makemake --nolink -f --deep -O out -KINET_PROJ=/home/wilhelm/Documents/omnetpp-5.5.1/samples/inet -DINET_IMPORT -I. -I$$\(INET_PROJ\)/src -L$$\(INET_PROJ\)/src -lINET$$\(D\) -d src -X.
#
