...
IntrusivePtr<AppS_S> MessageFactory::createAppS_S(unsigned int id_S, idMsg id, unsigned int SourceId,
		unsigned int SourceSeq, unsigned int Ses)
{
...
IntrusivePtr<App_resp> MessageFactory::createApp_resp(idMsg id, unsigned int s_resp, unsigned int seqS,
		unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<AppS_h> MessageFactory::createAppS_h(unsigned int seq_S, unsigned int id_S,
		const vector<unsigned int>& M_d, idMsg id)
{
...
IntrusivePtr<AppCo> MessageFactory::createAppCo(unsigned int id_S, unsigned int seq_S, unsigned int targetHostId,
		unsigned int Ses, idMsg id)
{
...
IntrusivePtr<AppCoAck> MessageFactory::createAppCoAck(unsigned int id_h, unsigned int seq_S, unsigned int Ses,
		unsigned int cellId)
{
...
IntrusivePtr<Ack_h> MessageFactory::createAck_h(unsigned int id_h, const vector<AckInterval>& intervals,
		unsigned int seq_S, unsigned int Ses, unsigned int id_S)
{
...
IntrusivePtr<AckSS> MessageFactory::createAckSS(unsigned int id_S,
		const vector<tuple<unsigned int, unsigned int, unsigned int>> &vseqAckSS, unsigned int SourceId,
...
IntrusivePtr<Init> MessageFactory::createInit(unsigned int targetHostId, unsigned int seq_S, unsigned int Ses,
		unsigned int Ses_LC, unsigned int id_S, MHState::STATE state)
{
...
IntrusivePtr<Req1> MessageFactory::createReq1(unsigned int id_h, unsigned int seq_S, unsigned int Ses_LC,
		unsigned int Ses, const StationGroup& MSSb, unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<Rsp1> MessageFactory::createRsp1(unsigned int id_h, unsigned int seq_h, const vector<idMsg>& m_nd,
		unsigned int Ses, unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<Req2> MessageFactory::createReq2(unsigned int id_h, const vector<idMsg>& msg_req, unsigned int Ses,
		const StationGroup &MSSb, unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<Rsp2> MessageFactory::createRsp2(unsigned int id_h, const vector<idMsg>& msg, const vector<idMsg>& msg_rcv,
		unsigned int Ses, unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<InitAck> MessageFactory::createInitAck(unsigned int id_S, unsigned int id_h, unsigned int seq_h,
		unsigned int seq_S, unsigned int Ses, const vector<tuple<idMsg, unsigned int>>& MsgOrder)
{
...
IntrusivePtr<Delete> MessageFactory::createDelete(unsigned int Ses, unsigned int id_h, unsigned int SourceId,
		unsigned int SourceSeq)
{
...
IntrusivePtr<Register> MessageFactory::createRegister(const Session& hi, unsigned int SourceId, unsigned int SourceSeq)
{
...
IntrusivePtr<RecoverMSSReq> MessageFactory::createRecoverMSSReq(unsigned int SourceId, unsigned int SourceSeq,
...
IntrusivePtr<RecoverMSS> MessageFactory::createRecoverMSS(unsigned int MSScible, unsigned int SourceId,
		unsigned int SourceSeq, const MSSSBuffer& SBuffer, unsigned int seq_S, unsigned int s_resp,
		const vector<unsigned int>& received, const map<unsigned int, vector<Session>>& Mobiles)
{
...
TimeoutHandoff* MessageFactory::createTimeoutHandoff(unsigned int idMH, unsigned int Ses, unsigned int SesLC,
		unsigned int seq_S)
{
