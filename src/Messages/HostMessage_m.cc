...
HostMessage::HostMessage() : ::inet::FieldsChunk()
{
}

HostMessage::HostMessage(const HostMessage& other) : ::inet::FieldsChunk(other)
{
    copy(other);
}
...
unsigned int HostMessage::getCellId() const
{
    return this->cellId;
}

void HostMessage::setCellId(unsigned int cellId)
{
    handleChange();
    this->cellId = cellId;
}
...
HostMessageDescriptor::HostMessageDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::HostMessage)), "inet::FieldsChunk")
{
...
int HostMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *HostMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string HostMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool HostMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *HostMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
