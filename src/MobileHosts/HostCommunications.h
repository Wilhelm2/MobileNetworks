...
struct statsMH
{
	unsigned int broadcastedMessagesSinceLastMeasure = 0; // Number of messages the host broadcasted since the last measure of the Stats module
	unsigned int totalDelivered = 0; // Total number of messages the host delivered
	unsigned int theoreticalNbWifiMessages = 0; // Total number of messages the host sent (through the sendMessage() function, knowing that sent messages might be grouped by TCP/UDP)
	unsigned int effectiveNbWifiMessages = 0; // Total number of messages that the host effectively sent (ie when taking into account the grouping of messages)
	unsigned int receivedMessages = 0; // Total number of received messages. Also takes into account messages received multiple times
};
