...
Session::Session(unsigned int id, unsigned int seqh, unsigned int seqc, const vector<AckInterval>& ackIntervals,
...
list<struct s_sendMsgMSS> Session::updateProcessReq1(vector<unsigned int>& recvReq1Vector, unsigned int SesReq1,
...
void Session::updateProcessRsp1(unsigned int seqh, const vector<unsigned int>& recvRsp1Vector,
