...
// Contains the messages a host that connects to a station must deliver before delivering messages currently broadcasted by the station
...
public:
	...
	// Removes the messages from the buffer whose sequence numbre is lower than minSeq, and returns the list of removed messages
